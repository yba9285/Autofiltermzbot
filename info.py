...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1001952500080'))  # Notification of those who verify will be sent to your channel
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002579486971 -1001626409260').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/H0J.jpg')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://yogedrasama:D8oNvWFxBws2et6W@cluster0.5m2w6n8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/how_to_open_mdiskshortner/9')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '0dc54d0cad495985f8e2c9bf1c6c82896bb537c7')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_open_mdiskshortner/9')  # Tutorial video link for opening shortlink website
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+MwTg-JpSlW8yMGY1')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'following-christal-omtech-dfc49dc3.koyeb.app/'))
